...
export const asyncRouterMap = [

    {
      ...
      children: [
        {
          path: 'list',
          component: _import('trade/list'),
          name: 'trade_list',
          meta: {title: '交易金额排行', icon: 'order', noCache: true}
        },
      ]
    },
    {
      ...
      children: [
        {
          path: 'list',
          component: _import('active/list'),
          name: 'active_list',
          meta: {title: '活跃终端排行', icon: 'order', noCache: true}
        },
      ]
    },
    {
      ...
      children: [
        {
          path: 'list',
          component: _import('un-trade/list'),
          name: 'untrade_list',
          meta: {title: '未交易终端', icon: 'order', noCache: true}
        },
      ]
    },
  {
...
/*    {
        ...
        children: [{
            ...
            name: 'test1',
            meta: {title: '测试', icon: 'documentation', noCache: true}
        }]
    },*/
